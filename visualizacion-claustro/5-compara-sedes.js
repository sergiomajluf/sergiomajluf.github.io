...
function preload() {
    txtScl = loadStrings("5-valores.txt");
    txtCcp = loadStrings("5-valores.txt");
    txtVal = loadStrings("5-valores.txt");
    txtPap = loadStrings("5-valores.txt");
    f_FiraSansLI = loadFont('fira-sans/FiraSans-Regular.otf');
}

function setup() {
    var cnv = createCanvas(windowWidth * 3, windowHeight * 2);
...
function mouseReleased() {
    //cicleThroughFiles();
    //location.reload();
    saveFrames('comparacion-sedes', 'png', 1, 1);
