var counts = {}
var dict = {}
var p1sm1, p1, txtVal, txtPap, allScl, allCcp, sllVal, allPap;
var keys = [];
...
function preload() {
    // ver manera programática de leer todo dentro de la carepta
    p01_01_s = loadStrings("preguntas/p01/p01-01-s.txt");
    p01_02_c = loadStrings("preguntas/p01/p01-02-c.txt");
    p01_02_v = loadStrings("preguntas/p01/p01-02-v.txt");
    p01_05_p = loadStrings("preguntas/p01/p01-05-p.txt");
    p01_06_p = loadStrings("preguntas/p01/p01-06-p.txt");
    p01_16_s = loadStrings("preguntas/p01/p01-16-s.txt");
...
function setup() {
    ...
    allScl = p01_01_s.join("\n");
    allCcp = p01_02_c.join("\n");
    allVal = p01_02_v.join("\n");
    allPap = p01_05_p.join("\n");
